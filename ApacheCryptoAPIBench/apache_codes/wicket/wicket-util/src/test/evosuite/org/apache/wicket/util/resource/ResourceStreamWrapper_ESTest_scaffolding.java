...
public class ResourceStreamWrapper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.wicket.util.resource.ResourceStreamWrapper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ResourceStreamWrapper_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, ResourceStreamWrapper_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.wicket.util.resource.IResourceStream", false, ResourceStreamWrapper_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ResourceStreamWrapper_ESTest_scaffolding.class.getClassLoader()); 
