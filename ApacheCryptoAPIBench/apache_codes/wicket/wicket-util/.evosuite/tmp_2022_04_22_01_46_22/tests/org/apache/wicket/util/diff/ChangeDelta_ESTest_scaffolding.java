...
public class ChangeDelta_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.wicket.util.diff.ChangeDelta"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ChangeDelta_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.wicket.util.diff.RevisionVisitor",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.wicket.util.diff.RevisionVisitor", false, ChangeDelta_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ChangeDelta_ESTest_scaffolding.class.getClassLoader()); 
