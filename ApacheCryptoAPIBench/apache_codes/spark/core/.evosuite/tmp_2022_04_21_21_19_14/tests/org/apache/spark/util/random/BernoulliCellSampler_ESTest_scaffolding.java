...
public class BernoulliCellSampler_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.util.random.BernoulliCellSampler"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BernoulliCellSampler_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.spark.util.random.BernoulliCellSampler$$anonfun$3",
      "org.apache.spark.util.random.BernoulliCellSampler$$anonfun$1",
      "scala.Predef$ArrowAssoc",
      "org.apache.spark.util.random.BernoulliCellSampler$$anonfun$2",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("scala.collection.Iterator", false, BernoulliCellSampler_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BernoulliCellSampler_ESTest_scaffolding.class.getClassLoader()); 
