...
public class LocalNettyRpcCallContext_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.rpc.netty.LocalNettyRpcCallContext"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LocalNettyRpcCallContext_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.spark.rpc.netty.RpcFailure",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Throwable", false, LocalNettyRpcCallContext_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.spark.rpc.RpcAddress", false, LocalNettyRpcCallContext_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.Function0", false, LocalNettyRpcCallContext_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.concurrent.Promise", false, LocalNettyRpcCallContext_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LocalNettyRpcCallContext_ESTest_scaffolding.class.getClassLoader()); 
