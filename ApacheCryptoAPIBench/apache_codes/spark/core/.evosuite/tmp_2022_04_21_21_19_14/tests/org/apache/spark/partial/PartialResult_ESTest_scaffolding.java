...
public class PartialResult_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.partial.PartialResult"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PartialResult_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.spark.partial.PartialResult$$anon$1",
      ...
      "org.apache.spark.partial.PartialResult$$anonfun$setFinalValue$1",
      ...
      "org.apache.spark.partial.PartialResult$$anonfun$setFailure$1",
      "scala.collection.mutable.Iterable$",
      "scala.Function0",
      "scala.Function1",
      "scala.Function2",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Exception", false, PartialResult_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.Function1", false, PartialResult_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.PartialFunction$AndThen", false, PartialResult_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.PartialFunction$Lifted", false, PartialResult_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.Some", false, PartialResult_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PartialResult_ESTest_scaffolding.class.getClassLoader()); 
