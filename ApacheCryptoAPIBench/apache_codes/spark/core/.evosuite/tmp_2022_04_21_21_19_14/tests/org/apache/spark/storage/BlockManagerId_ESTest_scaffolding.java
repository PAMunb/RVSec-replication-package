...
public class BlockManagerId_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.storage.BlockManagerId"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BlockManagerId_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "scala.collection.immutable.Stream$Cons",
      "org.apache.spark.storage.BlockManagerId$$anonfun$writeExternal$1",
      ...
      "org.apache.spark.storage.BlockManagerId$$anonfun$readExternal$1",
      "org.apache.spark.storage.BlockManagerId$$anonfun$writeExternal$1$$anonfun$apply$mcV$sp$1",
      "scala.Mutable",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.ObjectInput", false, BlockManagerId_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.ObjectOutput", false, BlockManagerId_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BlockManagerId_ESTest_scaffolding.class.getClassLoader()); 
