...
public class RestSubmissionClient_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.deploy.rest.RestSubmissionClient"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RestSubmissionClient_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.spark.deploy.rest.SubmissionStatusResponse",
      ...
      "scala.Option$",
      "scala.math.Numeric",
      "org.apache.spark.deploy.rest.SubmitRestProtocolRequest",
      ...
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$handleConnectionException$1",
      ...
      "scala.collection.mutable.HashTable",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$2",
      "com.fasterxml.jackson.annotation.JsonAutoDetect",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$1",
      ...
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$get$1",
      ...
      "org.apache.spark.deploy.rest.CreateSubmissionResponse",
      ...
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$requestSubmissionStatus$3",
      "scala.collection.generic.SeqForwarder$class",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$requestSubmissionStatus$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$requestSubmissionStatus$2",
      ...
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$getBaseUrl$1",
      ...
      "org.apache.spark.util.Utils$$anonfun$parseStandaloneMasterUrls$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.Throwable", false, RestSubmissionClient_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.Function0", false, RestSubmissionClient_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RestSubmissionClient_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "org.apache.spark.deploy.rest.RestSubmissionClient",
      "org.apache.spark.deploy.rest.RestSubmissionClient$",
      "scala.runtime.AbstractFunction0",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$createSubmission$1",
      "scala.runtime.AbstractFunction1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$createSubmission$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$createSubmission$3",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$killSubmission$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$killSubmission$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$killSubmission$3",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$requestSubmissionStatus$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$requestSubmissionStatus$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$requestSubmissionStatus$3",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$get$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$post$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$postJson$3",
      "scala.runtime.AbstractFunction0$mcV$sp",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$postJson$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$postJson$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$getBaseUrl$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$reportSubmissionStatus$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$reportSubmissionStatus$1",
      "scala.runtime.AbstractFunction1$mcVI$sp",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$pollSubmissionStatus$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$pollSubmissionStatus$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$3",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$4",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$reportSubmissionStatus$3",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$handleRestResponse$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$handleUnexpectedRestResponse$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$org$apache$spark$deploy$rest$RestSubmissionClient$$handleConnectionException$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$1$$anonfun$apply$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$1$$anonfun$apply$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$pollSubmissionStatus$1$$anonfun$apply$mcVI$sp$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$pollSubmissionStatus$1$$anonfun$apply$mcVI$sp$2",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$pollSubmissionStatus$1$$anonfun$apply$mcVI$sp$3",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$pollSubmissionStatus$1$$anonfun$apply$mcVI$sp$4$$anonfun$apply$3",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$filterSystemEnvironment$1",
      "org.apache.spark.deploy.rest.RestSubmissionClient$$anonfun$pollSubmissionStatus$1$$anonfun$apply$mcVI$sp$4",
      "com.fasterxml.jackson.annotation.JsonInclude$Include",
      "com.fasterxml.jackson.annotation.JsonAutoDetect$Visibility",
      "scala.LowPriorityImplicits",
      "scala.DeprecatedPredef$class",
      ...
      "org.scalatest.FunSpecLike$$anonfun$1",
