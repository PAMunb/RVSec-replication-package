...
public class SerializedMemoryEntry_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.storage.memory.SerializedMemoryEntry"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SerializedMemoryEntry_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.spark.util.io.ChunkedByteBuffer", false, SerializedMemoryEntry_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.reflect.ClassTag", false, SerializedMemoryEntry_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SerializedMemoryEntry_ESTest_scaffolding.class.getClassLoader()); 
