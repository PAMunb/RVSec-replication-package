...
public class ConsoleSink_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.metrics.sink.ConsoleSink"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ConsoleSink_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.codahale.metrics.MetricRegistry", false, ConsoleSink_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.spark.SecurityManager", false, ConsoleSink_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ConsoleSink_ESTest_scaffolding.class.getClassLoader()); 
