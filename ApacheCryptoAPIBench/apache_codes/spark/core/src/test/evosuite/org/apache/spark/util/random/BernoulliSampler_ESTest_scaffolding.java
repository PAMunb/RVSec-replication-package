...
public class BernoulliSampler_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.util.random.BernoulliSampler"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BernoulliSampler_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.spark.util.random.BernoulliSampler$$anonfun$4",
      ...
      "org.apache.spark.util.random.GapSampling$$anonfun$7",
      "org.apache.spark.util.random.GapSampling$$anonfun$6",
      ...
      "org.apache.spark.util.random.RandomSampler$$anonfun$sample$1",
      "scala.math.Ordered",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("scala.collection.Iterator", false, BernoulliSampler_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.reflect.ClassTag", false, BernoulliSampler_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BernoulliSampler_ESTest_scaffolding.class.getClassLoader()); 
