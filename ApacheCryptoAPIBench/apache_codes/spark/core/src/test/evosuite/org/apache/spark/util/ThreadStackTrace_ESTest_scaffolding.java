...
public class ThreadStackTrace_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.util.ThreadStackTrace"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ThreadStackTrace_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("scala.Option", false, ThreadStackTrace_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.collection.Seq", false, ThreadStackTrace_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ThreadStackTrace_ESTest_scaffolding.class.getClassLoader()); 
