...
public class ApplicationInfo_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.deploy.master.ApplicationInfo"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ApplicationInfo_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.spark.deploy.master.ApplicationInfo$$anonfun$1",
      ...
      "org.apache.spark.deploy.master.ApplicationSource$$anon$3",
      "scala.Product2$mcIJ$sp",
      "scala.collection.mutable.HashMap",
      "org.apache.spark.deploy.master.ApplicationSource$$anon$2",
      "scala.collection.$colon$plus$",
      "org.apache.spark.deploy.master.ApplicationSource$$anon$1",
      "scala.Predef$DummyImplicit$",
      "scala.util.Right",
      ...
      "scala.Cloneable",
      "org.apache.spark.deploy.master.ApplicationInfo$$anonfun$org$apache$spark$deploy$master$ApplicationInfo$$init$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Date", false, ApplicationInfo_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.spark.deploy.ApplicationDescription", false, ApplicationInfo_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.spark.rpc.RpcEndpointRef", false, ApplicationInfo_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.Option", false, ApplicationInfo_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("scala.Some", false, ApplicationInfo_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ApplicationInfo_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "org.apache.spark.deploy.master.ApplicationInfo",
      "scala.runtime.AbstractFunction0",
      "scala.runtime.AbstractFunction0$mcV$sp",
      "org.apache.spark.deploy.master.ApplicationInfo$$anonfun$readObject$1",
      "scala.runtime.AbstractFunction0$mcI$sp",
      "org.apache.spark.deploy.master.ApplicationInfo$$anonfun$org$apache$spark$deploy$master$ApplicationInfo$$init$1",
      "org.apache.spark.deploy.master.ApplicationInfo$$anonfun$1",
