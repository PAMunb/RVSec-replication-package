...
public class MeanEvaluator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.spark.partial.MeanEvaluator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MeanEvaluator_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "scala.Option",
      "org.apache.spark.util.StatCounter$$anonfun$merge$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.spark.util.StatCounter", false, MeanEvaluator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MeanEvaluator_ESTest_scaffolding.class.getClassLoader()); 
