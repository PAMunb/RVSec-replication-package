...
public class Invoker_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.deltaspike.core.impl.throttling.Invoker"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Invoker_ESTest_scaffolding.class.getClassLoader() ,
      "org.apache.deltaspike.core.impl.throttling.Invoker"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.concurrent.Semaphore", false, Invoker_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("javax.interceptor.InvocationContext", false, Invoker_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Invoker_ESTest_scaffolding.class.getClassLoader()); 
