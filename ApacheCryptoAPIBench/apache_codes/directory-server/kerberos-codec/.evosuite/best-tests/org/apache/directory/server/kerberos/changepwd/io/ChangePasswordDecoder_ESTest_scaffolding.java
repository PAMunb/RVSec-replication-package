...
public class ChangePasswordDecoder_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.directory.server.kerberos.changepwd.io.ChangePasswordDecoder"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ChangePasswordDecoder_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.apache.directory.server.kerberos.changepwd.io.ChangePasswordDecoder",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.nio.ByteBuffer", false, ChangePasswordDecoder_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ChangePasswordDecoder_ESTest_scaffolding.class.getClassLoader()); 
