...
public class StoreTill_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.directory.shared.kerberos.codec.kdcReqBody.actions.StoreTill"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StoreTill_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.directory.api.asn1.ber.tlv.BerValue", false, StoreTill_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.directory.api.asn1.ber.tlv.TLV", false, StoreTill_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.directory.shared.kerberos.codec.kdcReqBody.KdcReqBodyContainer", false, StoreTill_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.directory.shared.kerberos.components.KdcReqBody", false, StoreTill_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StoreTill_ESTest_scaffolding.class.getClassLoader()); 
