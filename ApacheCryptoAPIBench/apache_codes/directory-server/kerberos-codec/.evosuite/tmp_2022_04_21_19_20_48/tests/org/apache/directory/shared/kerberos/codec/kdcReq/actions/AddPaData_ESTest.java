...
public class AddPaData_ESTest extends AddPaData_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn((-86)).when(tLV0).getExpectedLength();
      doReturn((-695), 297).when(tLV0).getLength();
      ...
      addPaData0.action(kdcReqContainer0);
      assertEquals("KDC-REQ Add PA-DATA", addPaData0.toString());
  }
  ...
  public void test1()  throws Throwable  {
      AddPaData addPaData0 = new AddPaData();
      TLV tLV0 = mock(TLV.class, new ViolatedAssumptionAnswer());
      doReturn(297).when(tLV0).getLength();
      KdcReqContainer kdcReqContainer0 = mock(KdcReqContainer.class, new ViolatedAssumptionAnswer());
      doReturn(tLV0).when(kdcReqContainer0).getCurrentTLV();
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: Exception");
         ...
         //
         verifyException("org.apache.directory.shared.kerberos.codec.kdcReq.actions.AddPaData", e);
      }
  }
}
