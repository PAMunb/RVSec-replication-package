...
public class StoreEncTgsRepPart_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.directory.shared.kerberos.codec.encTgsRepPart.actions.StoreEncTgsRepPart"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(StoreEncTgsRepPart_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.nio.ByteBuffer", false, StoreEncTgsRepPart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.directory.api.asn1.ber.tlv.TLV", false, StoreEncTgsRepPart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.directory.shared.kerberos.codec.encTgsRepPart.EncTgsRepPartContainer", false, StoreEncTgsRepPart_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.directory.shared.kerberos.messages.EncTgsRepPart", false, StoreEncTgsRepPart_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(StoreEncTgsRepPart_ESTest_scaffolding.class.getClassLoader()); 
