...
public class CompositeParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.tika.parser.CompositeParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CompositeParser_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.tika.config.InitializableProblemHandler", false, CompositeParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.LoadErrorHandler", false, CompositeParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CompositeParser_ESTest_scaffolding.class.getClassLoader()); 
