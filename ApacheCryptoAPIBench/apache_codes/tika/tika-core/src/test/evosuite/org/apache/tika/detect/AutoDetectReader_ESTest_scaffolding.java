...
public class AutoDetectReader_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.LoadErrorHandler", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
  }
