...
public class AutoDetectReader_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.tika.detect.AutoDetectReader"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AutoDetectReader_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.charset.Charset", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.nio.charset.CharsetDecoder", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.ServiceLoader", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.detect.EncodingDetector", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.metadata.Metadata", false, AutoDetectReader_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AutoDetectReader_ESTest_scaffolding.class.getClassLoader()); 
