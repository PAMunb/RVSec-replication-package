...
public class DigestingParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.tika.parser.DigestingParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DigestingParser_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, DigestingParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.metadata.Metadata", false, DigestingParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.parser.DigestingParser$Digester", false, DigestingParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.parser.ParseContext", false, DigestingParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.xml.sax.ContentHandler", false, DigestingParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DigestingParser_ESTest_scaffolding.class.getClassLoader()); 
