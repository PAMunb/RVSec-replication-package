...
public class ParserPostProcessor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.tika.parser.ParserPostProcessor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ParserPostProcessor_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, ParserPostProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.LoadErrorHandler", false, ParserPostProcessor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.parser.DigestingParser$Encoder", false, ParserPostProcessor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ParserPostProcessor_ESTest_scaffolding.class.getClassLoader()); 
