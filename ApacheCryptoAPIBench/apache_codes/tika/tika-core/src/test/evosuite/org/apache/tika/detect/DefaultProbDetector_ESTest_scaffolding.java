...
public class DefaultProbDetector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.tika.detect.DefaultProbDetector"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultProbDetector_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.ClassLoader", false, DefaultProbDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, DefaultProbDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.ServiceLoader", false, DefaultProbDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.mime.MimeTypes", false, DefaultProbDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.mime.ProbabilisticMimeDetectionSelector", false, DefaultProbDetector_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultProbDetector_ESTest_scaffolding.class.getClassLoader()); 
