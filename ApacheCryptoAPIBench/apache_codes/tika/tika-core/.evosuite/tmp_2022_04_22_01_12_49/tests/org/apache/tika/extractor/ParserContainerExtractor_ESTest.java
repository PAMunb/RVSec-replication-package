...
public class ParserContainerExtractor_ESTest extends ParserContainerExtractor_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      ParserContainerExtractor parserContainerExtractor0 = new ParserContainerExtractor(parser0, (Detector) null);
      ParserContainerExtractor parserContainerExtractor1 = new ParserContainerExtractor((Parser) null, (Detector) null);
  ...
  public void test1()  throws Throwable  {
      ...
      doReturn(parser1).when(tikaConfig0).getParser();
      ParserContainerExtractor parserContainerExtractor1 = new ParserContainerExtractor(tikaConfig0);
      EmbeddedResourceHandler embeddedResourceHandler0 = mock(EmbeddedResourceHandler.class, new ViolatedAssumptionAnswer());
      // Undeclared exception!
      try { 
        parserContainerExtractor1.extract((TikaInputStream) null, parserContainerExtractor0, embeddedResourceHandler0);
        fail("Expecting exception: NullPointerException");
