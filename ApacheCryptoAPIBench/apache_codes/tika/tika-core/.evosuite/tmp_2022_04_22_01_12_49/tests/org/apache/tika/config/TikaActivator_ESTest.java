...
public class TikaActivator_ESTest extends TikaActivator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      doReturn(tikaActivator0).when(bundleContext0).getService(any(org.osgi.framework.ServiceReference.class));
      ...
      assertSame(tikaActivator0, object0);
  }
  ...
  public void test2()  throws Throwable  {
      ...
      doReturn(filter0, filter0).when(bundleContext0).createFilter(anyString());
      doReturn((Object) null, (Object) null).when(bundleContext0).getServiceReferences(anyString() , anyString());
      doReturn(true).when(bundleContext0).ungetService(any(org.osgi.framework.ServiceReference.class));
      tikaActivator0.start(bundleContext0);
      ServiceReference serviceReference0 = mock(ServiceReference.class, new ViolatedAssumptionAnswer());
      tikaActivator0.removedService(serviceReference0, (Object) null);
  }
  ...
  public void test5()  throws Throwable  {
      TikaActivator tikaActivator0 = new TikaActivator();
      ServiceReference serviceReference0 = mock(ServiceReference.class, new ViolatedAssumptionAnswer());
      doReturn(tikaActivator0).when(serviceReference0).getProperty(anyString());
  ...
  public void test7()  throws Throwable  {
      TikaActivator tikaActivator0 = new TikaActivator();
      ServiceReference serviceReference0 = mock(ServiceReference.class, new ViolatedAssumptionAnswer());
      tikaActivator0.modifiedService(serviceReference0, tikaActivator0);
  }
