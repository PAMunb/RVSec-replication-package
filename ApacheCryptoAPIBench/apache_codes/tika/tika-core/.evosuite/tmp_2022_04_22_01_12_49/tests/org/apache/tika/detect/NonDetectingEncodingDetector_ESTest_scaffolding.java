...
public class NonDetectingEncodingDetector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.tika.detect.NonDetectingEncodingDetector"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NonDetectingEncodingDetector_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.InputStream", false, NonDetectingEncodingDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.metadata.Metadata", false, NonDetectingEncodingDetector_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NonDetectingEncodingDetector_ESTest_scaffolding.class.getClassLoader()); 
