...
public class TikaConfig_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.tika.config.TikaConfig"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TikaConfig_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.net.URLStreamHandler", false, TikaConfig_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.InitializableProblemHandler", false, TikaConfig_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.LoadErrorHandler", false, TikaConfig_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TikaConfig_ESTest_scaffolding.class.getClassLoader()); 
