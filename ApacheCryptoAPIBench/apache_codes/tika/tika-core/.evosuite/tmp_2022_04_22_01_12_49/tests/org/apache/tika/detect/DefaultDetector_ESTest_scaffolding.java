...
public class DefaultDetector_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.ClassLoader", false, DefaultDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Enumeration", false, DefaultDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.config.ServiceLoader", false, DefaultDetector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.tika.mime.MimeTypes", false, DefaultDetector_ESTest_scaffolding.class.getClassLoader()));
  }
