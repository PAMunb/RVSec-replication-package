...
public class TaggedInputStream_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.IOException", false, TaggedInputStream_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.InputStream", false, TaggedInputStream_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.lang.Exception", false, TaggedInputStream_ESTest_scaffolding.class.getClassLoader()));
  }
