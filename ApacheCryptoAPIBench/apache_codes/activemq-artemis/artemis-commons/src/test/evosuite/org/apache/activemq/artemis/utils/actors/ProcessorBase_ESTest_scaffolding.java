...
public class ProcessorBase_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.activemq.artemis.utils.actors.ProcessorBase"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.ThreadGroup", false, ProcessorBase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.concurrent.Callable", false, ProcessorBase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, ProcessorBase_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.activemq.artemis.utils.actors.ActorListener", false, ProcessorBase_ESTest_scaffolding.class.getClassLoader()));
  }
