...
public class ClassloadingUtil_ESTest extends ClassloadingUtil_ESTest_scaffolding {
  ...
  public void test04()  throws Throwable  {
      // Undeclared exception!
      try { 
        ClassloadingUtil.newInstanceFromClassLoader("@Z+\"kw{voH|Qc,", (Object[]) null);
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // java.lang.ClassNotFoundException: Class '@Z+\"kw{voH|Qc,.class' should be in target project, but could not be found!
         //
         verifyException("org.apache.activemq.artemis.utils.ClassloadingUtil", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      URL uRL0 = ClassloadingUtil.findResource("Wea*e>]T5*hEe&");
      assertNull(uRL0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      Object object1 = ClassloadingUtil.newInstanceFromClassLoader("org.apache.activemq.artemis.utils.ClassloadingUtil", objectArray0);
