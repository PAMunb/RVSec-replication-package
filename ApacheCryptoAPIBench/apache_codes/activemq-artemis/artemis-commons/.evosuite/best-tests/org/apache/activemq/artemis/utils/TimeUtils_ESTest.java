...
public class TimeUtils_ESTest extends TimeUtils_ESTest_scaffolding {
  ...
  public void test2()  throws Throwable  {
      ...
      try { 
        TimeUtils.waitOnBoolean(false, 46L, (TimeUtils.CheckMethod) null);
  ...
  public void test3()  throws Throwable  {
      ...
      boolean boolean0 = TimeUtils.waitOnBoolean(true, 35L, timeUtils_CheckMethod0);
  ...
  public void test4()  throws Throwable  {
      TimeUtils.CheckMethod timeUtils_CheckMethod0 = mock(TimeUtils.CheckMethod.class, new ViolatedAssumptionAnswer());
      doReturn(false, false).when(timeUtils_CheckMethod0).check();
      boolean boolean0 = TimeUtils.waitOnBoolean(false, (-1168L), timeUtils_CheckMethod0);
      assertTrue(boolean0);
  }
}
