...
public class BinaryInput_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.manifoldcf.core.interfaces.BinaryInput"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BinaryInput_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.io.File", false, BinaryInput_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.IOException", false, BinaryInput_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.InputStream", false, BinaryInput_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BinaryInput_ESTest_scaffolding.class.getClassLoader()); 
