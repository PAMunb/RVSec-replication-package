...
```{r load}
bench03mop <- read.csv("../results/mop-report.csv", head=T, sep=",")
bench03cc  <- read.csv("../results/CogniCrypt-Report.csv", head=T, sep=",")
bench03cg <- read.csv("../results/CryptoGuard-Report.csv", head=T, sep=",")
