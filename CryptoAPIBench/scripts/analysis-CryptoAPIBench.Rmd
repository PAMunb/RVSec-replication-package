...
```{r load}
bench02mop <- read.csv("../results/MOP-Report.csv", head=T, sep=",")
bench02cc  <- read.csv("../results/CogniCrypt-Report.csv", head=T, sep=",")
bench02cg <- read.csv("../results/CryptoGuard-Report.csv", head=T, sep=",")
