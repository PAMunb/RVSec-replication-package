...
sqldf("select count (distinct className)
       from bench02cc
       where className in (select class from tn) and className like '%ABPS%'")
...
sqldf("select count (distinct className)
       from bench02cg
       where className in (select class from tncg) and className like '%ABPS%'")
...
## Accuracy Results for CryptoAPIBench
```{r table}
